...
async function execute(ctx, interaction) {
    ...
    if (applicationStatus && applicationStatus.status === "approved") return await interaction.reply({ content: "Songfish access is currently active for this server. Have fun!", ephemeral: true });
